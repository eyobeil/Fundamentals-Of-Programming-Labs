...
public class EmployeeBST  {
	...
	public EmployeeBST(NameComparator name) {
		root=null;
	}
	...
	public void insert(Employee x) {
		if (root == null) {
			...
			while(!inserted){
				if(x.getName().compareTo(n.element.getName())<0) {
				...
				else if(x.getName().compareTo(n.element.getName())>=0){ 
	...
	public static void main(String[] args){
		...
		bst.insert(new Employee("yobiel",2300,1998,01,11));
		bst.insert(new Employee("abel", 3000,2017,03,04));
		bst.printTree();
		System.out.println("Is yobiel in the tree? "+bst.find(new Employee("yobiel",2300,1998,01,11)));
		System.out.println("Is abel in the tree? "+bst.find(new Employee("abel",3000,2017,03,04)));
